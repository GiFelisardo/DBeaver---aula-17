...
alter table filme_categoria -- tabela que possui a chave estrangeira
add constraint fk_categoria -- adiciona restrição na tabela a ser alterada
foreign key (categoria_id) -- define a chave etrangeira na tabela a ser alterada
references categoria (categoria_id); -- refencia a tabela que possui a chave primária
